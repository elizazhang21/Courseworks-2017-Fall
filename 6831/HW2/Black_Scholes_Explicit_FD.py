...
def Black_Scholes_Explicit_FD(s_max, s_min, M, N, T, t, r, delta, sigma, payoff_function):
    # M = size of price
    # N = size of time
    ...
    option_price_explicit_FD = np.array(v_list)
    return option_price_explicit_FD

a = Black_Scholes_Explicit_FD(100, 0, 3, 3, 1, 0.5, 0.2, 0.1, 0.05, 'call')
print(a)
a = Black_Scholes_Explicit_FD(100, 0, 3, 3, 1, 0.5, 0.2, 0.1, 0.05, 'put')
print(a)
